...
namespace Torisho.Infrastructure.Migrations
{
    ...
    [Migration("20260610142239_AddPrivateRoomInvites")]
    partial class AddPrivateRoomInvites
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Torisho.Domain.Entities.DictionaryDomain.DictionaryEntryKanji", b =>
                {
                    b.Property<Guid>("DictionaryEntryId")
                        .HasColumnType("char(36)")
                        .HasColumnName("entry_id");
                    ...
                    b.HasKey("DictionaryEntryId", "KanjiId", "Position");
                    ...
                    b.HasIndex("KanjiId", "DictionaryEntryId")
                        .HasDatabaseName("idx_entry_kanji_map_lookup");

                    b.ToTable("entry_kanji_map", (string)null);
                });
            ...
            modelBuilder.Entity("Torisho.Domain.Entities.LearningDomain.LessonGrammarItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("LessonGrammarItems", (string)null);
                });

            modelBuilder.Entity("Torisho.Domain.Entities.LearningDomain.LessonReadingItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("LessonReadingItems", (string)null);
                });

            modelBuilder.Entity("Torisho.Domain.Entities.LearningDomain.LessonVocabularyItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("JlptTagsJson")
                        .HasColumnType("json");
                    ...
                    b.Property<string>("OtherFormsJson")
                        .HasColumnType("json");
                    ...
                    b.ToTable("LessonVocabularyItems", (string)null);
                });
            ...
            modelBuilder.Entity("Torisho.Domain.Entities.UserDomain.UserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Torisho.Domain.Entities.CommentDomain.DictionaryComment", b =>
                {
                    ...
                    b.HasOne("Torisho.Domain.Entities.CommentDomain.DictionaryComment", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("Torisho.Domain.Entities.LearningDomain.LessonGrammarItem", b =>
                {
                    b.HasOne("Torisho.Domain.Entities.LearningDomain.Lesson", "Lesson")
